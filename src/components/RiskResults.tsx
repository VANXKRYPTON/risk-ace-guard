      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className={`glass rounded-2xl p-8 md:p-12 border ${config.border}`}
          >
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-wrap items-center gap-4 justify-center lg:justify-start text-sm">
                  <span className="text-muted-foreground">
                    Confidence: <span className="text-foreground font-medium">{assessment.confidence}%</span>
                  </span>
                  <span className="text-muted-foreground">•</span>
                  <span className="text-muted-foreground">
                    Ensemble: <span className="text-foreground font-medium">GB + Z-Score + OEA</span>
                  </span>
                  {assessment.altmanZScore !== undefined && (
                    <>
                      <span className="text-muted-foreground">•</span>
                      <span className="text-muted-foreground">
                        Z-Score: <span className={`font-medium ${assessment.altmanZScore > 2.99 ? "text-risk-low" : assessment.altmanZScore > 1.81 ? "text-risk-medium" : "text-risk-high"}`}>{assessment.altmanZScore.toFixed(2)}</span>
                      </span>
                    </>
                  )}
                </div>
            ...
            {showDetails && (
              ...
              >
                ...
                <div className="lg:col-span-2">
                  <SensitivityAnalysis ratios={ratios} assessment={assessment} />
                </div>
